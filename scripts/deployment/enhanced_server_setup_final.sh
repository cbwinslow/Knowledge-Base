...
# ================================================
# 🛡️ ENHANCED SERVER SETUP SCRIPT
# ================================================
# 
# 📝 DESCRIPTION:
# This script automates the setup of a secure Linux server with:
# - Non-root user creation with sudo privileges
# - SSH hardening (disabled root login, password auth)
# - UFW firewall configuration
# - Development tools (Homebrew, Node.js, pnpm)
# - ZeroTier VPN installation
# - Ansible readiness (passwordless sudo)
# - Security enhancements (Fail2Ban, monitoring)
#
# 🚀 USAGE:
# 1. Edit configuration variables below or in server_setup.conf
# 2. Run with sudo: sudo ./enhanced_server_setup.sh
# 3. Follow prompts for any unset configuration values
#
# ⚠️ REQUIREMENTS:
# - Fresh Ubuntu/Debian server
# - Root access
# - SSH public key for the new user
#
# 📁 FILES CREATED:
# - /home/username/.ssh/authorized_keys
# - /etc/sudoers.d/90-ansible-user
...
# - Monitor logs in /var/log/ for suspicious activity
#
# ================================================
...
# --- 🚀 Configuration Variables (EDIT THESE OR SET IN CONFIG FILE) ---
NEW_USER="" # Will be prompted if not set
SSH_PUBLIC_KEY="" # Will be prompted if not set

# Try to load configuration from file
CONFIG_FILE="/home/$(logname 2>/dev/null || echo $USER)/server_setup.conf"
