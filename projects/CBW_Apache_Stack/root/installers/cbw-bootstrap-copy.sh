#!/usr/bin/env bash
#===============================================================================
# Script Name : cbw-bootstrap-copy.sh
# Author      : CBW + GPT-5 Thinking
# Date        : 2025-09-18
# Summary     : Copies scripts into canonical paths; sets permissions.
#===============================================================================
...
for f in cbw-metrics-install.sh cbw-install-kafka.sh cbw-install-solr.sh cbw-install-nifi.sh cbw-install-opensearch.sh cbw-install-apache-httpd.sh cbw-harden-ubuntu.sh cbw-postgres-readonly.sh; do
