#!/usr/bin/env bash
#===============================================================================
# Script Name : cbw-install-nifi.sh
# Author      : CBW + GPT-5 Thinking
# Date        : 2025-09-18
# Summary     : Bare-metal install of Apache NiFi with auto-port (localhost bind).
#===============================================================================
set -euo pipefail; trap 'echo "[ERROR] $LINENO" >&2' ERR
PORT_NIFI_DEFAULT=8089
PORT_NIFI=$( /usr/local/sbin/cbw-port-guard.sh reserve NIFI_HTTP "$PORT_NIFI_DEFAULT" | tail -n1 )
