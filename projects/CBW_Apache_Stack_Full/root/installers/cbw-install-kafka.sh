...
PORT_KAFKA=$( /usr/local/sbin/cbw-port-guard.sh reserve KAFKA 9092 | tail -n1 )
PORT_KRAFT_CTRL=$( /usr/local/sbin/cbw-port-guard.sh reserve KAFKA_CTRL 9093 | tail -n1 )
